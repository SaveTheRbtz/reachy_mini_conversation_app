...
export function createOrb({ initialState = ORB_STATES.IDLE } = {}) {
    const indicator = h("span", { class: "convo-orb__indicator", "aria-hidden": "true" }, micIcon(), micOffIcon(), spinnerIndicator(), errorIcon());
    const root = h("button", {
        type: "button",
        class: "convo-orb",
    ...
    }, h("span", { class: "convo-orb__glow", "aria-hidden": "true" }), h("span", { class: "convo-orb__ring", "aria-hidden": "true" }), h("span", { class: "convo-orb__ring-outer", "aria-hidden": "true" }), h("span", { class: "convo-orb__core" }, indicator));
